...
handler(struct UTrapframe *utf)
{
  ...
  80007a:	c7 44 24 08 20 12 80 	movl   $0x801220,0x8(%esp)
  800081:	00 
  800082:	c7 44 24 04 0e 00 00 	movl   $0xe,0x4(%esp)
  800089:	00 
  80008a:	c7 04 24 0a 12 80 00 	movl   $0x80120a,(%esp)
  800091:	e8 ba 00 00 00       	call   800150 <_panic>
	snprintf((char*) addr, 100, "this string was faulted in at %x", addr);
  800096:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  80009a:	c7 44 24 08 4c 12 80 	movl   $0x80124c,0x8(%esp)
  8000a1:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80017c:	c7 04 24 78 12 80 00 	movl   $0x801278,(%esp)
  ...
  800192:	e8 51 00 00 00       	call   8001e8 <vcprintf>
	cprintf("\n");
  800197:	c7 04 24 1e 12 80 00 	movl   $0x80121e,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80033f:	e8 4c 0d 00 00       	call   801090 <__umoddi3>
  800344:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800348:	0f be 80 9b 12 80 00 	movsbl 0x80129b(%eax),%eax
...
008003de <vprintfmt>:
{
  ...
  800463:	ff 24 8d 60 13 80 00 	jmp    *0x801360(,%ecx,4)
  ...
  80052f:	c7 44 24 08 bc 12 80 	movl   $0x8012bc,0x8(%esp)
  800536:	00 
  ...
  800561:	b8 ac 12 80 00       	mov    $0x8012ac,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c30:	00 
  800c31:	c7 44 24 08 e4 14 80 	movl   $0x8014e4,0x8(%esp)
  800c38:	00 
  800c39:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c40:	00 
  800c41:	c7 04 24 01 15 80 00 	movl   $0x801501,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800cc2:	00 
  800cc3:	c7 44 24 08 e4 14 80 	movl   $0x8014e4,0x8(%esp)
  800cca:	00 
  800ccb:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cd2:	00 
  800cd3:	c7 04 24 01 15 80 00 	movl   $0x801501,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d68:	00 
  800d69:	c7 44 24 08 e4 14 80 	movl   $0x8014e4,0x8(%esp)
  800d70:	00 
  800d71:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d78:	00 
  800d79:	c7 04 24 01 15 80 00 	movl   $0x801501,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800dbb:	00 
  800dbc:	c7 44 24 08 e4 14 80 	movl   $0x8014e4,0x8(%esp)
  800dc3:	00 
  800dc4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dcb:	00 
  800dcc:	c7 04 24 01 15 80 00 	movl   $0x801501,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e0e:	00 
  800e0f:	c7 44 24 08 e4 14 80 	movl   $0x8014e4,0x8(%esp)
  800e16:	00 
  800e17:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e1e:	00 
  800e1f:	c7 04 24 01 15 80 00 	movl   $0x801501,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e83:	00 
  800e84:	c7 44 24 08 e4 14 80 	movl   $0x8014e4,0x8(%esp)
  800e8b:	00 
  800e8c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e93:	00 
  800e94:	c7 04 24 01 15 80 00 	movl   $0x801501,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800eb6:	75 6f                	jne    800f27 <set_pgfault_handler+0x7f>
		// First time through!
  ...
  800ed9:	79 1c                	jns    800ef7 <set_pgfault_handler+0x4f>
			panic("set_pgfault_handler: sys_page_alloc() failed\n");
  800edb:	c7 44 24 08 10 15 80 	movl   $0x801510,0x8(%esp)
  800ee2:	00 
  800ee3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800eea:	00 
  800eeb:	c7 04 24 74 15 80 00 	movl   $0x801574,(%esp)
  800ef2:	e8 59 f2 ff ff       	call   800150 <_panic>
		
		if ( (r = sys_env_set_pgfault_upcall(envid, _pgfault_upcall)) < 0 )
  800ef7:	c7 44 24 04 35 0f 80 	movl   $0x800f35,0x4(%esp)
  800efe:	00 
  800eff:	89 1c 24             	mov    %ebx,(%esp)
  800f02:	e8 d9 fe ff ff       	call   800de0 <sys_env_set_pgfault_upcall>
  800f07:	85 c0                	test   %eax,%eax
  800f09:	79 1c                	jns    800f27 <set_pgfault_handler+0x7f>
			panic("set_pgfault_handler: sys_env_set_pgfault_upcall\n");
  800f0b:	c7 44 24 08 40 15 80 	movl   $0x801540,0x8(%esp)
  800f12:	00 
  800f13:	c7 44 24 04 26 00 00 	movl   $0x26,0x4(%esp)
  800f1a:	00 
  800f1b:	c7 04 24 74 15 80 00 	movl   $0x801574,(%esp)
  800f22:	e8 29 f2 ff ff       	call   800150 <_panic>
  ...
  800f2f:	83 c4 14             	add    $0x14,%esp
  800f32:	5b                   	pop    %ebx
  800f33:	5d                   	pop    %ebp
  800f34:	c3                   	ret    

00800f35 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800f40:	83 c4 08             	add    $0x8,%esp
	mov 32(%esp), %ebx
  800f43:	8b 5c 24 20          	mov    0x20(%esp),%ebx
	mov 40(%esp), %eax
  800f47:	8b 44 24 28          	mov    0x28(%esp),%eax
	sub $4, %eax
  800f4b:	83 e8 04             	sub    $0x4,%eax
	mov %ebx, (%eax)
  800f4e:	89 18                	mov    %ebx,(%eax)
  ...
  800f55:	5c                   	pop    %esp
	...
	// LAB 4: Your code here.
	lea -4(%esp), %esp
  800f56:	8d 64 24 fc          	lea    -0x4(%esp),%esp
	ret
  800f5a:	c3                   	ret    
