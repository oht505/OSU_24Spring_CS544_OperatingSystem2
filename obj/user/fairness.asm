...
umain(int argc, char **argv)
{
  ...
  80008f:	c7 04 24 31 12 80 00 	movl   $0x801231,(%esp)
  ...
  8000bb:	e8 c8 0d 00 00       	call   800e88 <ipc_send>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80024f:	e8 3c 0d 00 00       	call   800f90 <__udivdi3>
  ...
  8002af:	e8 0c 0e 00 00       	call   8010c0 <__umoddi3>
  8002b4:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8002b8:	0f be 80 52 12 80 00 	movsbl 0x801252(%eax),%eax
...
0080034e <vprintfmt>:
{
  ...
  8003d3:	ff 24 8d 20 13 80 00 	jmp    *0x801320(,%ecx,4)
  ...
  80049f:	c7 44 24 08 73 12 80 	movl   $0x801273,0x8(%esp)
  8004a6:	00 
  ...
  8004d1:	b8 63 12 80 00       	mov    $0x801263,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ba0:	00 
  800ba1:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800ba8:	00 
  800ba9:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bb0:	00 
  800bb1:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
  800bb8:	e8 6e 03 00 00       	call   800f2b <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c32:	00 
  800c33:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800c3a:	00 
  800c3b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c42:	00 
  800c43:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
  800c4a:	e8 dc 02 00 00       	call   800f2b <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c85:	00 
  800c86:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800c8d:	00 
  800c8e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c95:	00 
  800c96:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
  800c9d:	e8 89 02 00 00       	call   800f2b <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cd8:	00 
  800cd9:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800ce0:	00 
  800ce1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ce8:	00 
  800ce9:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
  800cf0:	e8 36 02 00 00       	call   800f2b <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d2b:	00 
  800d2c:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800d33:	00 
  800d34:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d3b:	00 
  800d3c:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
  800d43:	e8 e3 01 00 00       	call   800f2b <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d7e:	00 
  800d7f:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800d86:	00 
  800d87:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d8e:	00 
  800d8f:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
  800d96:	e8 90 01 00 00       	call   800f2b <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800df3:	00 
  800df4:	c7 44 24 08 a4 14 80 	movl   $0x8014a4,0x8(%esp)
  800dfb:	00 
  800dfc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e03:	00 
  800e04:	c7 04 24 c1 14 80 00 	movl   $0x8014c1,(%esp)
  800e0b:	e8 1b 01 00 00       	call   800f2b <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800e31:	85 c0                	test   %eax,%eax
	void *dstva = (void *)(-1);
  800e33:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  800e38:	0f 44 c2             	cmove  %edx,%eax
		dstva = pg;

	if ((r = sys_ipc_recv(dstva)) < 0)
  800e3b:	89 04 24             	mov    %eax,(%esp)
  800e3e:	e8 83 ff ff ff       	call   800dc6 <sys_ipc_recv>
  800e43:	85 c0                	test   %eax,%eax
  800e45:	79 16                	jns    800e5d <ipc_recv+0x3d>
	{
		if (from_env_store)
  800e47:	85 f6                	test   %esi,%esi
  800e49:	74 06                	je     800e51 <ipc_recv+0x31>
			*from_env_store = 0;
  800e4b:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		
		if (perm_store)
  800e51:	85 db                	test   %ebx,%ebx
  800e53:	74 2c                	je     800e81 <ipc_recv+0x61>
			*perm_store = 0;
  800e55:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  800e5b:	eb 24                	jmp    800e81 <ipc_recv+0x61>
  ...
  800e5f:	74 0a                	je     800e6b <ipc_recv+0x4b>
  ...
  800e6d:	74 0a                	je     800e79 <ipc_recv+0x59>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800e9a:	85 db                	test   %ebx,%ebx
	void *srcva = (void *)(-1);
  800e9c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  800ea1:	0f 44 d8             	cmove  %eax,%ebx
  ...
  800eab:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800eaf:	89 74 24 04          	mov    %esi,0x4(%esp)
  800eb3:	89 3c 24             	mov    %edi,(%esp)
  800eb6:	e8 e8 fe ff ff       	call   800da3 <sys_ipc_try_send>

		if (r == 0)
  800ebb:	85 c0                	test   %eax,%eax
  800ebd:	74 2c                	je     800eeb <ipc_send+0x63>
			break;
		
		if (r == -E_IPC_NOT_RECV)
  800ebf:	83 f8 f9             	cmp    $0xfffffff9,%eax
  800ec2:	75 07                	jne    800ecb <ipc_send+0x43>
		{
			sys_yield();
  800ec4:	e8 1b fd ff ff       	call   800be4 <sys_yield>
			continue;
		}

		panic("ipc_send: %e", r);
	}
  800ec9:	eb d9                	jmp    800ea4 <ipc_send+0x1c>
		panic("ipc_send: %e", r);
  800ecb:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800ecf:	c7 44 24 08 cf 14 80 	movl   $0x8014cf,0x8(%esp)
  800ed6:	00 
  800ed7:	c7 44 24 04 56 00 00 	movl   $0x56,0x4(%esp)
  800ede:	00 
  800edf:	c7 04 24 dc 14 80 00 	movl   $0x8014dc,(%esp)
  800ee6:	e8 40 00 00 00       	call   800f2b <_panic>
...
ipc_find_env(enum EnvType type)
{
  ...
  800efe:	6b d0 7c             	imul   $0x7c,%eax,%edx
  800f01:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  800f07:	8b 52 50             	mov    0x50(%edx),%edx
  800f0a:	39 ca                	cmp    %ecx,%edx
  800f0c:	75 0d                	jne    800f1b <ipc_find_env+0x28>
			return envs[i].env_id;
  800f0e:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800f11:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  800f16:	8b 40 40             	mov    0x40(%eax),%eax
  800f19:	eb 0e                	jmp    800f29 <ipc_find_env+0x36>
	for (i = 0; i < NENV; i++)
  800f1b:	83 c0 01             	add    $0x1,%eax
  800f1e:	3d 00 04 00 00       	cmp    $0x400,%eax
  800f23:	75 d9                	jne    800efe <ipc_find_env+0xb>
	return 0;
  800f25:	66 b8 00 00          	mov    $0x0,%ax
}
  800f29:	5d                   	pop    %ebp
  800f2a:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800f30:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800f33:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800f36:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800f3c:	e8 84 fc ff ff       	call   800bc5 <sys_getenvid>
  800f41:	8b 55 0c             	mov    0xc(%ebp),%edx
  800f44:	89 54 24 10          	mov    %edx,0x10(%esp)
  800f48:	8b 55 08             	mov    0x8(%ebp),%edx
  800f4b:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800f4f:	89 74 24 08          	mov    %esi,0x8(%esp)
  800f53:	89 44 24 04          	mov    %eax,0x4(%esp)
  800f57:	c7 04 24 e8 14 80 00 	movl   $0x8014e8,(%esp)
  800f5e:	e8 5e f2 ff ff       	call   8001c1 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800f63:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800f67:	8b 45 10             	mov    0x10(%ebp),%eax
  800f6a:	89 04 24             	mov    %eax,(%esp)
  800f6d:	e8 ee f1 ff ff       	call   800160 <vcprintf>
	cprintf("\n");
  800f72:	c7 04 24 2f 12 80 00 	movl   $0x80122f,(%esp)
  800f79:	e8 43 f2 ff ff       	call   8001c1 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800f7e:	cc                   	int3   
  800f7f:	eb fd                	jmp    800f7e <_panic+0x53>
