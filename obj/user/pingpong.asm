...
umain(int argc, char **argv)
{
  ...
  800039:	83 ec 2c             	sub    $0x2c,%esp
	...
	if ((who = fork()) != 0) {
  80003c:	e8 53 0f 00 00       	call   800f94 <fork>
  ...
  800086:	e8 9d 11 00 00       	call   801228 <ipc_send>
  ...
  8000a0:	e8 1b 11 00 00       	call   8011c0 <ipc_recv>
  ...
  8000e9:	e8 3a 11 00 00       	call   801228 <ipc_send>
		if (i == 10)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80028f:	e8 4c 11 00 00       	call   8013e0 <__udivdi3>
  ...
  8002ef:	e8 1c 12 00 00       	call   801510 <__umoddi3>
...
sys_env_destroy(envid_t envid)
{
  ...
  800bf8:	e8 ce 06 00 00       	call   8012cb <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c8a:	e8 3c 06 00 00       	call   8012cb <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cdd:	e8 e9 05 00 00       	call   8012cb <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d30:	e8 96 05 00 00       	call   8012cb <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d83:	e8 43 05 00 00       	call   8012cb <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dd6:	e8 f0 04 00 00       	call   8012cb <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800e4b:	e8 7b 04 00 00       	call   8012cb <_panic>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800e6b:	c7 44 24 08 2f 19 80 	movl   $0x80192f,0x8(%esp)
  800e72:	00 
  800e73:	c7 44 24 04 1e 00 00 	movl   $0x1e,0x4(%esp)
  800e7a:	00 
  800e7b:	c7 04 24 46 19 80 00 	movl   $0x801946,(%esp)
  800e82:	e8 44 04 00 00       	call   8012cb <_panic>
  ...
  800e98:	c7 44 24 08 51 19 80 	movl   $0x801951,0x8(%esp)
  800e9f:	00 
  800ea0:	c7 44 24 04 21 00 00 	movl   $0x21,0x4(%esp)
  800ea7:	00 
  800ea8:	c7 04 24 46 19 80 00 	movl   $0x801946,(%esp)
  800eaf:	e8 17 04 00 00       	call   8012cb <_panic>
  ...
  800ebb:	c7 44 24 08 06 00 00 	movl   $0x6,0x8(%esp)
  800ec2:	00 
  ...
  800ed5:	79 20                	jns    800ef7 <pgfault+0x9f>
		panic("pgfault: sys_page_alloc() failed %e", r);
  800ed7:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800edb:	c7 44 24 08 8c 19 80 	movl   $0x80198c,0x8(%esp)
  800ee2:	00 
  800ee3:	c7 44 24 04 2d 00 00 	movl   $0x2d,0x4(%esp)
  800eea:	00 
  800eeb:	c7 04 24 46 19 80 00 	movl   $0x801946,(%esp)
  800ef2:	e8 d4 03 00 00       	call   8012cb <_panic>

	//memcpy( (void *)PFTEMP, (void *)PTE_ADDR(addr), PGSIZE );
	memcpy( (void *)PFTEMP, (void *)ROUNDDOWN(addr, PGSIZE), PGSIZE );
  800ef7:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  ...
  800f10:	e8 17 fb ff ff       	call   800a2c <memcpy>

	if ((r = sys_page_map(envid, (void *)PFTEMP, envid, (void *)ROUNDDOWN(addr, PGSIZE), (PTE_U|PTE_W))) < 0)
  800f15:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
  800f1c:	00 
  800f1d:	89 74 24 0c          	mov    %esi,0xc(%esp)
  800f21:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800f25:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800f2c:	00 
  800f2d:	89 1c 24             	mov    %ebx,(%esp)
  800f30:	e8 62 fd ff ff       	call   800c97 <sys_page_map>
  800f35:	85 c0                	test   %eax,%eax
  800f37:	79 20                	jns    800f59 <pgfault+0x101>
		panic("pgfault: sys_page_map() failed %e", r);
  800f39:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f3d:	c7 44 24 08 b0 19 80 	movl   $0x8019b0,0x8(%esp)
  800f44:	00 
  800f45:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  800f4c:	00 
  800f4d:	c7 04 24 46 19 80 00 	movl   $0x801946,(%esp)
  800f54:	e8 72 03 00 00       	call   8012cb <_panic>
	
	if ((r = sys_page_unmap(envid, (void *)PFTEMP)) < 0)
  800f59:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800f60:	00 
  800f61:	89 1c 24             	mov    %ebx,(%esp)
  800f64:	e8 81 fd ff ff       	call   800cea <sys_page_unmap>
  800f69:	85 c0                	test   %eax,%eax
  800f6b:	79 20                	jns    800f8d <pgfault+0x135>
		panic("pgfault: sys_page_unmap() failed %e", r);
  800f6d:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f71:	c7 44 24 08 d4 19 80 	movl   $0x8019d4,0x8(%esp)
  800f78:	00 
  800f79:	c7 44 24 04 36 00 00 	movl   $0x36,0x4(%esp)
  800f80:	00 
  800f81:	c7 04 24 46 19 80 00 	movl   $0x801946,(%esp)
  800f88:	e8 3e 03 00 00       	call   8012cb <_panic>
...
fork(void)
{
  ...
  800f9d:	c7 04 24 58 0e 80 00 	movl   $0x800e58,(%esp)
  800fa4:	e8 78 03 00 00       	call   801321 <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  800fb7:	0f 88 d3 01 00 00    	js     801190 <fork+0x1fc>
		return envid;

	if (envid == 0)
  800fbd:	bb 00 00 00 00       	mov    $0x0,%ebx
  800fc2:	85 c0                	test   %eax,%eax
  800fc4:	75 21                	jne    800fe7 <fork+0x53>
	{
		envid = sys_getenvid();
  800fc6:	e8 3a fc ff ff       	call   800c05 <sys_getenvid>

		thisenv = &envs[ENVX(envid)];
  800fcb:	25 ff 03 00 00       	and    $0x3ff,%eax
  800fd0:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800fd3:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800fd8:	a3 04 20 80 00       	mov    %eax,0x802004
		return 0;
  800fdd:	b8 00 00 00 00       	mov    $0x0,%eax
  800fe2:	e9 ad 01 00 00       	jmp    801194 <fork+0x200>
	}
  ...
  800ff5:	75 0b                	jne    801002 <fork+0x6e>
		{
			va += NPTENTRIES * PGSIZE;
  800ff7:	81 c3 00 00 40 00    	add    $0x400000,%ebx
			continue;
  800ffd:	e9 22 01 00 00       	jmp    801124 <fork+0x190>
		}
  ...
  801010:	75 0b                	jne    80101d <fork+0x89>
		{
			va += PGSIZE;
  801012:	81 c3 00 10 00 00    	add    $0x1000,%ebx
			continue;
  801018:	e9 07 01 00 00       	jmp    801124 <fork+0x190>
		}
		
		if (va == (UXSTACKTOP - PGSIZE))
  80101d:	81 fb 00 f0 bf ee    	cmp    $0xeebff000,%ebx
  801023:	0f 84 07 01 00 00    	je     801130 <fork+0x19c>
		{
			va += PGSIZE;
			continue;
		}
  ...
  801030:	e8 d0 fb ff ff       	call   800c05 <sys_getenvid>
  801035:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  ...
  801044:	a9 02 08 00 00       	test   $0x802,%eax
  801049:	0f 84 89 00 00 00    	je     8010d8 <fork+0x144>
		if ( (r = sys_page_map(p_envid , (void *)va, envid, (void *)va, (PTE_COW | PTE_U))) < 0 )
  80104f:	c7 44 24 10 04 08 00 	movl   $0x804,0x10(%esp)
  801056:	00 
  801057:	89 74 24 0c          	mov    %esi,0xc(%esp)
  ...
  80106c:	e8 26 fc ff ff       	call   800c97 <sys_page_map>
  801071:	85 c0                	test   %eax,%eax
  801073:	79 20                	jns    801095 <fork+0x101>
			panic("duppage: %e", r);
  801075:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801079:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  801080:	00 
  801081:	c7 44 24 04 53 00 00 	movl   $0x53,0x4(%esp)
  801088:	00 
  801089:	c7 04 24 46 19 80 00 	movl   $0x801946,(%esp)
  801090:	e8 36 02 00 00       	call   8012cb <_panic>
		if ( (r = sys_page_map(p_envid , (void *)va, p_envid, (void *)va,  (PTE_COW | PTE_U) )) < 0 )
  801095:	c7 44 24 10 04 08 00 	movl   $0x804,0x10(%esp)
  80109c:	00 
  80109d:	89 74 24 0c          	mov    %esi,0xc(%esp)
  ...
  8010af:	e8 e3 fb ff ff       	call   800c97 <sys_page_map>
  8010b4:	85 c0                	test   %eax,%eax
  8010b6:	79 66                	jns    80111e <fork+0x18a>
			panic("duppage: %e", r);
  8010b8:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8010bc:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  8010c3:	00 
  8010c4:	c7 44 24 04 56 00 00 	movl   $0x56,0x4(%esp)
  8010cb:	00 
  8010cc:	c7 04 24 46 19 80 00 	movl   $0x801946,(%esp)
  8010d3:	e8 f3 01 00 00       	call   8012cb <_panic>
		if ( (r = sys_page_map(p_envid, (void *)va, envid, (void *)va, PTE_U)) < 0 )
  8010d8:	c7 44 24 10 04 00 00 	movl   $0x4,0x10(%esp)
  8010df:	00 
  ...
  8010f5:	e8 9d fb ff ff       	call   800c97 <sys_page_map>
  8010fa:	85 c0                	test   %eax,%eax
  8010fc:	79 20                	jns    80111e <fork+0x18a>
			panic("duppage: %e", r);
  8010fe:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801102:	c7 44 24 08 68 19 80 	movl   $0x801968,0x8(%esp)
  801109:	00 
  80110a:	c7 44 24 04 5b 00 00 	movl   $0x5b,0x4(%esp)
  801111:	00 
  801112:	c7 04 24 46 19 80 00 	movl   $0x801946,(%esp)
  801119:	e8 ad 01 00 00       	call   8012cb <_panic>
			return r;

		va += PGSIZE;
  80111e:	81 c3 00 10 00 00    	add    $0x1000,%ebx
	for ( uintptr_t va = 0; va < UTOP; )
  801124:	81 fb ff ff bf ee    	cmp    $0xeebfffff,%ebx
  80112a:	0f 86 b7 fe ff ff    	jbe    800fe7 <fork+0x53>
	}

	if ( (r = sys_page_alloc(envid, (void *) (UXSTACKTOP - PGSIZE), (PTE_U | PTE_W))) < 0)
  801130:	c7 44 24 08 06 00 00 	movl   $0x6,0x8(%esp)
  801137:	00 
  801138:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  80113f:	ee 
  801140:	89 3c 24             	mov    %edi,(%esp)
  801143:	e8 fb fa ff ff       	call   800c43 <sys_page_alloc>
  801148:	85 c0                	test   %eax,%eax
  80114a:	78 48                	js     801194 <fork+0x200>
		return r;

	extern void _pgfault_upcall(void);
	sys_env_set_pgfault_upcall(envid, _pgfault_upcall);
  80114c:	c7 44 24 04 ae 13 80 	movl   $0x8013ae,0x4(%esp)
  801153:	00 
  801154:	89 3c 24             	mov    %edi,(%esp)
  801157:	e8 34 fc ff ff       	call   800d90 <sys_env_set_pgfault_upcall>

	if ((r = sys_env_set_status(envid, ENV_RUNNABLE)) < 0)
  80115c:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  801163:	00 
  801164:	89 3c 24             	mov    %edi,(%esp)
  801167:	e8 d1 fb ff ff       	call   800d3d <sys_env_set_status>
  80116c:	85 c0                	test   %eax,%eax
  80116e:	79 22                	jns    801192 <fork+0x1fe>
		panic("fork: sys_env_set_status() failed %e", r);
  801170:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801174:	c7 44 24 08 f8 19 80 	movl   $0x8019f8,0x8(%esp)
  80117b:	00 
  80117c:	c7 44 24 04 ac 00 00 	movl   $0xac,0x4(%esp)
  801183:	00 
  801184:	c7 04 24 46 19 80 00 	movl   $0x801946,(%esp)
  80118b:	e8 3b 01 00 00       	call   8012cb <_panic>
  801190:	eb 02                	jmp    801194 <fork+0x200>
...
sfork(void)
{
  ...
  8011a2:	c7 44 24 08 74 19 80 	movl   $0x801974,0x8(%esp)
  8011a9:	00 
  8011aa:	c7 44 24 04 b6 00 00 	movl   $0xb6,0x4(%esp)
  8011b1:	00 
  8011b2:	c7 04 24 46 19 80 00 	movl   $0x801946,(%esp)
  8011b9:	e8 0d 01 00 00       	call   8012cb <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8011d1:	85 c0                	test   %eax,%eax
	void *dstva = (void *)(-1);
  8011d3:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  8011d8:	0f 44 c2             	cmove  %edx,%eax
		dstva = pg;

	if ((r = sys_ipc_recv(dstva)) < 0)
  8011db:	89 04 24             	mov    %eax,(%esp)
  8011de:	e8 23 fc ff ff       	call   800e06 <sys_ipc_recv>
  8011e3:	85 c0                	test   %eax,%eax
  8011e5:	79 16                	jns    8011fd <ipc_recv+0x3d>
	{
		if (from_env_store)
  8011e7:	85 f6                	test   %esi,%esi
  8011e9:	74 06                	je     8011f1 <ipc_recv+0x31>
			*from_env_store = 0;
  8011eb:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		
		if (perm_store)
  8011f1:	85 db                	test   %ebx,%ebx
  8011f3:	74 2c                	je     801221 <ipc_recv+0x61>
			*perm_store = 0;
  8011f5:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  8011fb:	eb 24                	jmp    801221 <ipc_recv+0x61>
  ...
  8011ff:	74 0a                	je     80120b <ipc_recv+0x4b>
		*from_env_store = thisenv->env_ipc_from;
  801201:	a1 04 20 80 00       	mov    0x802004,%eax
  801206:	8b 40 74             	mov    0x74(%eax),%eax
  801209:	89 06                	mov    %eax,(%esi)
	
	if (perm_store)
  80120b:	85 db                	test   %ebx,%ebx
  80120d:	74 0a                	je     801219 <ipc_recv+0x59>
  ...
  801219:	a1 04 20 80 00       	mov    0x802004,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801234:	8b 75 0c             	mov    0xc(%ebp),%esi
  ...
  801247:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80124b:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  80124f:	89 74 24 04          	mov    %esi,0x4(%esp)
  801253:	89 3c 24             	mov    %edi,(%esp)
  801256:	e8 88 fb ff ff       	call   800de3 <sys_ipc_try_send>

		if (r == 0)
  80125b:	85 c0                	test   %eax,%eax
  80125d:	74 2c                	je     80128b <ipc_send+0x63>
			break;
		
		if (r == -E_IPC_NOT_RECV)
  80125f:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801262:	75 07                	jne    80126b <ipc_send+0x43>
		{
			sys_yield();
  801264:	e8 bb f9 ff ff       	call   800c24 <sys_yield>
			continue;
		}

		panic("ipc_send: %e", r);
	}
  801269:	eb d9                	jmp    801244 <ipc_send+0x1c>
		panic("ipc_send: %e", r);
  80126b:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80126f:	c7 44 24 08 1d 1a 80 	movl   $0x801a1d,0x8(%esp)
  801276:	00 
  801277:	c7 44 24 04 56 00 00 	movl   $0x56,0x4(%esp)
  80127e:	00 
  80127f:	c7 04 24 2a 1a 80 00 	movl   $0x801a2a,(%esp)
  801286:	e8 40 00 00 00       	call   8012cb <_panic>
...
ipc_find_env(enum EnvType type)
{
  ...
  8012ac:	75 0d                	jne    8012bb <ipc_find_env+0x28>
			return envs[i].env_id;
  8012ae:	6b c0 7c             	imul   $0x7c,%eax,%eax
  8012b1:	05 08 00 c0 ee       	add    $0xeec00008,%eax
  8012b6:	8b 40 40             	mov    0x40(%eax),%eax
  8012b9:	eb 0e                	jmp    8012c9 <ipc_find_env+0x36>
	for (i = 0; i < NENV; i++)
  8012bb:	83 c0 01             	add    $0x1,%eax
  8012be:	3d 00 04 00 00       	cmp    $0x400,%eax
  8012c3:	75 d9                	jne    80129e <ipc_find_env+0xb>
	return 0;
  8012c5:	66 b8 00 00          	mov    $0x0,%ax
}
  8012c9:	5d                   	pop    %ebp
  8012ca:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8012d0:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  8012d3:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8012d6:	8b 35 00 20 80 00    	mov    0x802000,%esi
  8012dc:	e8 24 f9 ff ff       	call   800c05 <sys_getenvid>
  8012e1:	8b 55 0c             	mov    0xc(%ebp),%edx
  8012e4:	89 54 24 10          	mov    %edx,0x10(%esp)
  8012e8:	8b 55 08             	mov    0x8(%ebp),%edx
  8012eb:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8012ef:	89 74 24 08          	mov    %esi,0x8(%esp)
  8012f3:	89 44 24 04          	mov    %eax,0x4(%esp)
  8012f7:	c7 04 24 34 1a 80 00 	movl   $0x801a34,(%esp)
  8012fe:	e8 f7 ee ff ff       	call   8001fa <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801303:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  801307:	8b 45 10             	mov    0x10(%ebp),%eax
  80130a:	89 04 24             	mov    %eax,(%esp)
  80130d:	e8 87 ee ff ff       	call   800199 <vcprintf>
	cprintf("\n");
  801312:	c7 04 24 66 19 80 00 	movl   $0x801966,(%esp)
  801319:	e8 dc ee ff ff       	call   8001fa <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  80131e:	cc                   	int3   
  80131f:	eb fd                	jmp    80131e <_panic+0x53>

00801321 <set_pgfault_handler>:
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  80132f:	75 6f                	jne    8013a0 <set_pgfault_handler+0x7f>
		// First time through!
		// LAB 4: Your code here.
		envid_t envid = sys_getenvid();
  801331:	e8 cf f8 ff ff       	call   800c05 <sys_getenvid>
  801336:	89 c3                	mov    %eax,%ebx
		
		if ( (r = sys_page_alloc(envid, (void *)(UXSTACKTOP - PGSIZE), (PTE_U | PTE_W | PTE_P))) < 0 )
  801338:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  80133f:	00 
  801340:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  801347:	ee 
  801348:	89 04 24             	mov    %eax,(%esp)
  80134b:	e8 f3 f8 ff ff       	call   800c43 <sys_page_alloc>
  801350:	85 c0                	test   %eax,%eax
  801352:	79 1c                	jns    801370 <set_pgfault_handler+0x4f>
			panic("set_pgfault_handler: sys_page_alloc() failed\n");
  801354:	c7 44 24 08 58 1a 80 	movl   $0x801a58,0x8(%esp)
  80135b:	00 
  80135c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801363:	00 
  801364:	c7 04 24 bc 1a 80 00 	movl   $0x801abc,(%esp)
  80136b:	e8 5b ff ff ff       	call   8012cb <_panic>
		
		if ( (r = sys_env_set_pgfault_upcall(envid, _pgfault_upcall)) < 0 )
  801370:	c7 44 24 04 ae 13 80 	movl   $0x8013ae,0x4(%esp)
  801377:	00 
  801378:	89 1c 24             	mov    %ebx,(%esp)
  80137b:	e8 10 fa ff ff       	call   800d90 <sys_env_set_pgfault_upcall>
  801380:	85 c0                	test   %eax,%eax
  801382:	79 1c                	jns    8013a0 <set_pgfault_handler+0x7f>
			panic("set_pgfault_handler: sys_env_set_pgfault_upcall\n");
  801384:	c7 44 24 08 88 1a 80 	movl   $0x801a88,0x8(%esp)
  80138b:	00 
  80138c:	c7 44 24 04 26 00 00 	movl   $0x26,0x4(%esp)
  801393:	00 
  801394:	c7 04 24 bc 1a 80 00 	movl   $0x801abc,(%esp)
  80139b:	e8 2b ff ff ff       	call   8012cb <_panic>
  ...
  8013a3:	a3 08 20 80 00       	mov    %eax,0x802008
}
...
_pgfault_upcall:
  ...
  8013ce:	5c                   	pop    %esp
	...
	// LAB 4: Your code here.
	lea -4(%esp), %esp
  8013cf:	8d 64 24 fc          	lea    -0x4(%esp),%esp
	ret
  8013d3:	c3                   	ret    
