	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80021f:	e8 dc 0c 00 00       	call   800f00 <__udivdi3>
  ...
  80027f:	e8 ac 0d 00 00       	call   801030 <__umoddi3>
  800284:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800288:	0f be 80 c6 11 80 00 	movsbl 0x8011c6(%eax),%eax
...
0080031e <vprintfmt>:
{
  ...
  8003a3:	ff 24 8d 80 12 80 00 	jmp    *0x801280(,%ecx,4)
  ...
  80046f:	c7 44 24 08 e7 11 80 	movl   $0x8011e7,0x8(%esp)
  800476:	00 
  ...
  8004a1:	b8 d7 11 80 00       	mov    $0x8011d7,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b70:	00 
  800b71:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800b78:	00 
  800b79:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b80:	00 
  800b81:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
  800b88:	e8 0e 03 00 00       	call   800e9b <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c02:	00 
  800c03:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800c0a:	00 
  800c0b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c12:	00 
  800c13:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
  800c1a:	e8 7c 02 00 00       	call   800e9b <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c55:	00 
  800c56:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800c5d:	00 
  800c5e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c65:	00 
  800c66:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
  800c6d:	e8 29 02 00 00       	call   800e9b <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800ca8:	00 
  800ca9:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800cb0:	00 
  800cb1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cb8:	00 
  800cb9:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
  800cc0:	e8 d6 01 00 00       	call   800e9b <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cfb:	00 
  800cfc:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800d03:	00 
  800d04:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d0b:	00 
  800d0c:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
  800d13:	e8 83 01 00 00       	call   800e9b <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d4e:	00 
  800d4f:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800d56:	00 
  800d57:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d5e:	00 
  800d5f:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
  800d66:	e8 30 01 00 00       	call   800e9b <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800dc3:	00 
  800dc4:	c7 44 24 08 04 14 80 	movl   $0x801404,0x8(%esp)
  800dcb:	00 
  800dcc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dd3:	00 
  800dd4:	c7 04 24 21 14 80 00 	movl   $0x801421,(%esp)
  800ddb:	e8 bb 00 00 00       	call   800e9b <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800deb:	53                   	push   %ebx
  800dec:	83 ec 14             	sub    $0x14,%esp
	int r;

	if (_pgfault_handler == 0) {
  800def:	83 3d 08 20 80 00 00 	cmpl   $0x0,0x802008
  800df6:	75 6f                	jne    800e67 <set_pgfault_handler+0x7f>
		// First time through!
		// LAB 4: Your code here.
		envid_t envid = sys_getenvid();
  800df8:	e8 98 fd ff ff       	call   800b95 <sys_getenvid>
  ...
  800e19:	79 1c                	jns    800e37 <set_pgfault_handler+0x4f>
			panic("set_pgfault_handler: sys_page_alloc() failed\n");
  800e1b:	c7 44 24 08 30 14 80 	movl   $0x801430,0x8(%esp)
  800e22:	00 
  800e23:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e2a:	00 
  800e2b:	c7 04 24 91 14 80 00 	movl   $0x801491,(%esp)
  800e32:	e8 64 00 00 00       	call   800e9b <_panic>
		
		if ( (r = sys_env_set_pgfault_upcall(envid, _pgfault_upcall)) < 0 )
  800e37:	c7 44 24 04 75 0e 80 	movl   $0x800e75,0x4(%esp)
  800e3e:	00 
  800e3f:	89 1c 24             	mov    %ebx,(%esp)
  800e42:	e8 d9 fe ff ff       	call   800d20 <sys_env_set_pgfault_upcall>
  800e47:	85 c0                	test   %eax,%eax
  800e49:	79 1c                	jns    800e67 <set_pgfault_handler+0x7f>
			panic("set_pgfault_handler: sys_env_set_pgfault_upcall\n");
  800e4b:	c7 44 24 08 60 14 80 	movl   $0x801460,0x8(%esp)
  800e52:	00 
  800e53:	c7 44 24 04 26 00 00 	movl   $0x26,0x4(%esp)
  800e5a:	00 
  800e5b:	c7 04 24 91 14 80 00 	movl   $0x801491,(%esp)
  800e62:	e8 34 00 00 00       	call   800e9b <_panic>
  ...
  800e6a:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800e6f:	83 c4 14             	add    $0x14,%esp
  800e72:	5b                   	pop    %ebx
  800e73:	5d                   	pop    %ebp
  800e74:	c3                   	ret    

00800e75 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800e76:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800e7d:	83 c4 04             	add    $0x4,%esp
	...
	// LAB 4: Your code here.
	add $8, %esp
  800e80:	83 c4 08             	add    $0x8,%esp
	mov 32(%esp), %ebx
  800e83:	8b 5c 24 20          	mov    0x20(%esp),%ebx
	mov 40(%esp), %eax
  800e87:	8b 44 24 28          	mov    0x28(%esp),%eax
	sub $4, %eax
  800e8b:	83 e8 04             	sub    $0x4,%eax
	mov %ebx, (%eax)
  ...
  800e95:	5c                   	pop    %esp
	...
	// LAB 4: Your code here.
	lea -4(%esp), %esp
  800e96:	8d 64 24 fc          	lea    -0x4(%esp),%esp
	ret
  800e9a:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800eac:	e8 e4 fc ff ff       	call   800b95 <sys_getenvid>
  ...
  800ec7:	c7 04 24 a0 14 80 00 	movl   $0x8014a0,(%esp)
  800ece:	e8 be f2 ff ff       	call   800191 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800ed3:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800ed7:	8b 45 10             	mov    0x10(%ebp),%eax
  800eda:	89 04 24             	mov    %eax,(%esp)
  800edd:	e8 4e f2 ff ff       	call   800130 <vcprintf>
	cprintf("\n");
  800ee2:	c7 04 24 ba 11 80 00 	movl   $0x8011ba,(%esp)
  800ee9:	e8 a3 f2 ff ff       	call   800191 <cprintf>
