...
umain(int argc, char **argv)
{
  ...
  80004f:	bb 00 00 00 00       	mov    $0x0,%ebx
		if (fork() == 0)
  800054:	e8 9b 0f 00 00       	call   800ff4 <fork>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002ef:	e8 ec 0f 00 00       	call   8012e0 <__udivdi3>
  ...
  80034f:	e8 bc 10 00 00       	call   801410 <__umoddi3>
...
pgfault(struct UTrapframe *utf)
{
  ...
  800ecb:	c7 44 24 08 6f 18 80 	movl   $0x80186f,0x8(%esp)
  800ed2:	00 
  800ed3:	c7 44 24 04 1e 00 00 	movl   $0x1e,0x4(%esp)
  800eda:	00 
  800edb:	c7 04 24 86 18 80 00 	movl   $0x801886,(%esp)
  ...
  800ef8:	c7 44 24 08 91 18 80 	movl   $0x801891,0x8(%esp)
  800eff:	00 
  800f00:	c7 44 24 04 21 00 00 	movl   $0x21,0x4(%esp)
  800f07:	00 
  800f08:	c7 04 24 86 18 80 00 	movl   $0x801886,(%esp)
  ...
  800f1b:	c7 44 24 08 06 00 00 	movl   $0x6,0x8(%esp)
  800f22:	00 
  ...
  800f35:	79 20                	jns    800f57 <pgfault+0x9f>
		panic("pgfault: sys_page_alloc() failed %e", r);
  800f37:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f3b:	c7 44 24 08 cc 18 80 	movl   $0x8018cc,0x8(%esp)
  800f42:	00 
  800f43:	c7 44 24 04 2d 00 00 	movl   $0x2d,0x4(%esp)
  800f4a:	00 
  800f4b:	c7 04 24 86 18 80 00 	movl   $0x801886,(%esp)
  800f52:	e8 16 f2 ff ff       	call   80016d <_panic>

	//memcpy( (void *)PFTEMP, (void *)PTE_ADDR(addr), PGSIZE );
	memcpy( (void *)PFTEMP, (void *)ROUNDDOWN(addr, PGSIZE), PGSIZE );
  800f57:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  800f5d:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
  800f64:	00 
  800f65:	89 74 24 04          	mov    %esi,0x4(%esp)
  800f69:	c7 04 24 00 f0 7f 00 	movl   $0x7ff000,(%esp)
  800f70:	e8 17 fb ff ff       	call   800a8c <memcpy>

	if ((r = sys_page_map(envid, (void *)PFTEMP, envid, (void *)ROUNDDOWN(addr, PGSIZE), (PTE_U|PTE_W))) < 0)
  800f75:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
  800f7c:	00 
  800f7d:	89 74 24 0c          	mov    %esi,0xc(%esp)
  800f81:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800f85:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800f8c:	00 
  800f8d:	89 1c 24             	mov    %ebx,(%esp)
  800f90:	e8 62 fd ff ff       	call   800cf7 <sys_page_map>
  800f95:	85 c0                	test   %eax,%eax
  800f97:	79 20                	jns    800fb9 <pgfault+0x101>
		panic("pgfault: sys_page_map() failed %e", r);
  800f99:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800f9d:	c7 44 24 08 f0 18 80 	movl   $0x8018f0,0x8(%esp)
  800fa4:	00 
  800fa5:	c7 44 24 04 33 00 00 	movl   $0x33,0x4(%esp)
  800fac:	00 
  800fad:	c7 04 24 86 18 80 00 	movl   $0x801886,(%esp)
  800fb4:	e8 b4 f1 ff ff       	call   80016d <_panic>
	
	if ((r = sys_page_unmap(envid, (void *)PFTEMP)) < 0)
  800fb9:	c7 44 24 04 00 f0 7f 	movl   $0x7ff000,0x4(%esp)
  800fc0:	00 
  800fc1:	89 1c 24             	mov    %ebx,(%esp)
  800fc4:	e8 81 fd ff ff       	call   800d4a <sys_page_unmap>
  800fc9:	85 c0                	test   %eax,%eax
  800fcb:	79 20                	jns    800fed <pgfault+0x135>
		panic("pgfault: sys_page_unmap() failed %e", r);
  800fcd:	89 44 24 0c          	mov    %eax,0xc(%esp)
  800fd1:	c7 44 24 08 14 19 80 	movl   $0x801914,0x8(%esp)
  800fd8:	00 
  800fd9:	c7 44 24 04 36 00 00 	movl   $0x36,0x4(%esp)
  800fe0:	00 
  800fe1:	c7 04 24 86 18 80 00 	movl   $0x801886,(%esp)
  800fe8:	e8 80 f1 ff ff       	call   80016d <_panic>
...
fork(void)
{
  ...
  800ffd:	c7 04 24 b8 0e 80 00 	movl   $0x800eb8,(%esp)
  801004:	e8 15 02 00 00       	call   80121e <set_pgfault_handler>
...
sys_exofork(void)
{
  ...
  801017:	0f 88 d3 01 00 00    	js     8011f0 <fork+0x1fc>
		return envid;

	if (envid == 0)
  80101d:	bb 00 00 00 00       	mov    $0x0,%ebx
  801022:	85 c0                	test   %eax,%eax
  801024:	75 21                	jne    801047 <fork+0x53>
	{
		envid = sys_getenvid();
  801026:	e8 3a fc ff ff       	call   800c65 <sys_getenvid>

		thisenv = &envs[ENVX(envid)];
  80102b:	25 ff 03 00 00       	and    $0x3ff,%eax
  801030:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801033:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801038:	a3 08 20 80 00       	mov    %eax,0x802008
		return 0;
  80103d:	b8 00 00 00 00       	mov    $0x0,%eax
  801042:	e9 ad 01 00 00       	jmp    8011f4 <fork+0x200>
	}
  ...
  801055:	75 0b                	jne    801062 <fork+0x6e>
		{
			va += NPTENTRIES * PGSIZE;
  801057:	81 c3 00 00 40 00    	add    $0x400000,%ebx
			continue;
  80105d:	e9 22 01 00 00       	jmp    801184 <fork+0x190>
		}
  ...
  801070:	75 0b                	jne    80107d <fork+0x89>
		{
			va += PGSIZE;
  801072:	81 c3 00 10 00 00    	add    $0x1000,%ebx
			continue;
  801078:	e9 07 01 00 00       	jmp    801184 <fork+0x190>
		}
		
		if (va == (UXSTACKTOP - PGSIZE))
  80107d:	81 fb 00 f0 bf ee    	cmp    $0xeebff000,%ebx
  801083:	0f 84 07 01 00 00    	je     801190 <fork+0x19c>
		{
			va += PGSIZE;
			continue;
		}
  ...
  801090:	e8 d0 fb ff ff       	call   800c65 <sys_getenvid>
  ...
  8010a9:	0f 84 89 00 00 00    	je     801138 <fork+0x144>
		if ( (r = sys_page_map(p_envid , (void *)va, envid, (void *)va, (PTE_COW | PTE_U))) < 0 )
  8010af:	c7 44 24 10 04 08 00 	movl   $0x804,0x10(%esp)
  8010b6:	00 
  8010b7:	89 74 24 0c          	mov    %esi,0xc(%esp)
  8010bb:	8b 45 e0             	mov    -0x20(%ebp),%eax
  ...
  8010cc:	e8 26 fc ff ff       	call   800cf7 <sys_page_map>
  8010d1:	85 c0                	test   %eax,%eax
  8010d3:	79 20                	jns    8010f5 <fork+0x101>
			panic("duppage: %e", r);
  8010d5:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8010d9:	c7 44 24 08 a8 18 80 	movl   $0x8018a8,0x8(%esp)
  8010e0:	00 
  8010e1:	c7 44 24 04 53 00 00 	movl   $0x53,0x4(%esp)
  8010e8:	00 
  8010e9:	c7 04 24 86 18 80 00 	movl   $0x801886,(%esp)
  8010f0:	e8 78 f0 ff ff       	call   80016d <_panic>
		if ( (r = sys_page_map(p_envid , (void *)va, p_envid, (void *)va,  (PTE_COW | PTE_U) )) < 0 )
  8010f5:	c7 44 24 10 04 08 00 	movl   $0x804,0x10(%esp)
  8010fc:	00 
  8010fd:	89 74 24 0c          	mov    %esi,0xc(%esp)
  801101:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801104:	89 44 24 08          	mov    %eax,0x8(%esp)
  801108:	89 74 24 04          	mov    %esi,0x4(%esp)
  80110c:	89 04 24             	mov    %eax,(%esp)
  80110f:	e8 e3 fb ff ff       	call   800cf7 <sys_page_map>
  801114:	85 c0                	test   %eax,%eax
  801116:	79 66                	jns    80117e <fork+0x18a>
			panic("duppage: %e", r);
  801118:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80111c:	c7 44 24 08 a8 18 80 	movl   $0x8018a8,0x8(%esp)
  801123:	00 
  801124:	c7 44 24 04 56 00 00 	movl   $0x56,0x4(%esp)
  80112b:	00 
  80112c:	c7 04 24 86 18 80 00 	movl   $0x801886,(%esp)
  801133:	e8 35 f0 ff ff       	call   80016d <_panic>
		if ( (r = sys_page_map(p_envid, (void *)va, envid, (void *)va, PTE_U)) < 0 )
  801138:	c7 44 24 10 04 00 00 	movl   $0x4,0x10(%esp)
  80113f:	00 
  801140:	89 74 24 0c          	mov    %esi,0xc(%esp)
  801144:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801147:	89 44 24 08          	mov    %eax,0x8(%esp)
  80114b:	89 74 24 04          	mov    %esi,0x4(%esp)
  80114f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801152:	89 04 24             	mov    %eax,(%esp)
  801155:	e8 9d fb ff ff       	call   800cf7 <sys_page_map>
  80115a:	85 c0                	test   %eax,%eax
  80115c:	79 20                	jns    80117e <fork+0x18a>
			panic("duppage: %e", r);
  80115e:	89 44 24 0c          	mov    %eax,0xc(%esp)
  801162:	c7 44 24 08 a8 18 80 	movl   $0x8018a8,0x8(%esp)
  801169:	00 
  80116a:	c7 44 24 04 5b 00 00 	movl   $0x5b,0x4(%esp)
  801171:	00 
  801172:	c7 04 24 86 18 80 00 	movl   $0x801886,(%esp)
  801179:	e8 ef ef ff ff       	call   80016d <_panic>
			return r;

		va += PGSIZE;
  80117e:	81 c3 00 10 00 00    	add    $0x1000,%ebx
	for ( uintptr_t va = 0; va < UTOP; )
  801184:	81 fb ff ff bf ee    	cmp    $0xeebfffff,%ebx
  80118a:	0f 86 b7 fe ff ff    	jbe    801047 <fork+0x53>
	}

	if ( (r = sys_page_alloc(envid, (void *) (UXSTACKTOP - PGSIZE), (PTE_U | PTE_W))) < 0)
  801190:	c7 44 24 08 06 00 00 	movl   $0x6,0x8(%esp)
  801197:	00 
  801198:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  80119f:	ee 
  8011a0:	89 3c 24             	mov    %edi,(%esp)
  8011a3:	e8 fb fa ff ff       	call   800ca3 <sys_page_alloc>
  8011a8:	85 c0                	test   %eax,%eax
  8011aa:	78 48                	js     8011f4 <fork+0x200>
		return r;

	extern void _pgfault_upcall(void);
	sys_env_set_pgfault_upcall(envid, _pgfault_upcall);
  8011ac:	c7 44 24 04 ab 12 80 	movl   $0x8012ab,0x4(%esp)
  8011b3:	00 
  8011b4:	89 3c 24             	mov    %edi,(%esp)
  8011b7:	e8 34 fc ff ff       	call   800df0 <sys_env_set_pgfault_upcall>

	if ((r = sys_env_set_status(envid, ENV_RUNNABLE)) < 0)
  8011bc:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
  8011c3:	00 
  8011c4:	89 3c 24             	mov    %edi,(%esp)
  8011c7:	e8 d1 fb ff ff       	call   800d9d <sys_env_set_status>
  8011cc:	85 c0                	test   %eax,%eax
  8011ce:	79 22                	jns    8011f2 <fork+0x1fe>
		panic("fork: sys_env_set_status() failed %e", r);
  8011d0:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8011d4:	c7 44 24 08 38 19 80 	movl   $0x801938,0x8(%esp)
  8011db:	00 
  8011dc:	c7 44 24 04 ac 00 00 	movl   $0xac,0x4(%esp)
  8011e3:	00 
  8011e4:	c7 04 24 86 18 80 00 	movl   $0x801886,(%esp)
  8011eb:	e8 7d ef ff ff       	call   80016d <_panic>
  8011f0:	eb 02                	jmp    8011f4 <fork+0x200>

	//panic("fork not implemented");
	return envid;
  8011f2:	89 f8                	mov    %edi,%eax
}
...
sfork(void)
{
  ...
  801202:	c7 44 24 08 b4 18 80 	movl   $0x8018b4,0x8(%esp)
  801209:	00 
  80120a:	c7 44 24 04 b6 00 00 	movl   $0xb6,0x4(%esp)
  801211:	00 
  801212:	c7 04 24 86 18 80 00 	movl   $0x801886,(%esp)
  801219:	e8 4f ef ff ff       	call   80016d <_panic>

0080121e <set_pgfault_handler>:
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  801225:	83 3d 0c 20 80 00 00 	cmpl   $0x0,0x80200c
  80122c:	75 6f                	jne    80129d <set_pgfault_handler+0x7f>
		// First time through!
		// LAB 4: Your code here.
		envid_t envid = sys_getenvid();
  80122e:	e8 32 fa ff ff       	call   800c65 <sys_getenvid>
  801233:	89 c3                	mov    %eax,%ebx
		
		if ( (r = sys_page_alloc(envid, (void *)(UXSTACKTOP - PGSIZE), (PTE_U | PTE_W | PTE_P))) < 0 )
  801235:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%esp)
  80123c:	00 
  80123d:	c7 44 24 04 00 f0 bf 	movl   $0xeebff000,0x4(%esp)
  801244:	ee 
  801245:	89 04 24             	mov    %eax,(%esp)
  801248:	e8 56 fa ff ff       	call   800ca3 <sys_page_alloc>
  80124d:	85 c0                	test   %eax,%eax
  80124f:	79 1c                	jns    80126d <set_pgfault_handler+0x4f>
			panic("set_pgfault_handler: sys_page_alloc() failed\n");
  801251:	c7 44 24 08 60 19 80 	movl   $0x801960,0x8(%esp)
  801258:	00 
  801259:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  801260:	00 
  801261:	c7 04 24 c4 19 80 00 	movl   $0x8019c4,(%esp)
  801268:	e8 00 ef ff ff       	call   80016d <_panic>
		
		if ( (r = sys_env_set_pgfault_upcall(envid, _pgfault_upcall)) < 0 )
  80126d:	c7 44 24 04 ab 12 80 	movl   $0x8012ab,0x4(%esp)
  801274:	00 
  801275:	89 1c 24             	mov    %ebx,(%esp)
  801278:	e8 73 fb ff ff       	call   800df0 <sys_env_set_pgfault_upcall>
  80127d:	85 c0                	test   %eax,%eax
  80127f:	79 1c                	jns    80129d <set_pgfault_handler+0x7f>
			panic("set_pgfault_handler: sys_env_set_pgfault_upcall\n");
  801281:	c7 44 24 08 90 19 80 	movl   $0x801990,0x8(%esp)
  801288:	00 
  801289:	c7 44 24 04 26 00 00 	movl   $0x26,0x4(%esp)
  801290:	00 
  801291:	c7 04 24 c4 19 80 00 	movl   $0x8019c4,(%esp)
  801298:	e8 d0 ee ff ff       	call   80016d <_panic>
...
_pgfault_upcall:
  ...
  8012b6:	83 c4 08             	add    $0x8,%esp
	mov 32(%esp), %ebx
  8012b9:	8b 5c 24 20          	mov    0x20(%esp),%ebx
	mov 40(%esp), %eax
  8012bd:	8b 44 24 28          	mov    0x28(%esp),%eax
	sub $4, %eax
  8012c1:	83 e8 04             	sub    $0x4,%eax
	mov %ebx, (%eax)
  8012c4:	89 18                	mov    %ebx,(%eax)
  ...
  8012cb:	5c                   	pop    %esp
	...
	// LAB 4: Your code here.
	lea -4(%esp), %esp
  8012cc:	8d 64 24 fc          	lea    -0x4(%esp),%esp
	ret
  8012d0:	c3                   	ret    
  8012d1:	66 90                	xchg   %ax,%ax
...
008012e0 <__udivdi3>:
  ...
  8012ea:	8b 7c 24 1c          	mov    0x1c(%esp),%edi
  8012ee:	8b 6c 24 20          	mov    0x20(%esp),%ebp
  8012f2:	8b 4c 24 24          	mov    0x24(%esp),%ecx
  8012f6:	85 c0                	test   %eax,%eax
  8012f8:	89 7c 24 04          	mov    %edi,0x4(%esp)
  8012fc:	89 ea                	mov    %ebp,%edx
  8012fe:	89 0c 24             	mov    %ecx,(%esp)
  801301:	75 2d                	jne    801330 <__udivdi3+0x50>
  801303:	39 e9                	cmp    %ebp,%ecx
  801305:	77 61                	ja     801368 <__udivdi3+0x88>
  801307:	85 c9                	test   %ecx,%ecx
  801309:	89 ce                	mov    %ecx,%esi
  80130b:	75 0b                	jne    801318 <__udivdi3+0x38>
  80130d:	b8 01 00 00 00       	mov    $0x1,%eax
  801312:	31 d2                	xor    %edx,%edx
  801314:	f7 f1                	div    %ecx
  801316:	89 c6                	mov    %eax,%esi
  801318:	31 d2                	xor    %edx,%edx
  80131a:	89 e8                	mov    %ebp,%eax
  80131c:	f7 f6                	div    %esi
  80131e:	89 c5                	mov    %eax,%ebp
  801320:	89 f8                	mov    %edi,%eax
  801322:	f7 f6                	div    %esi
  801324:	89 ea                	mov    %ebp,%edx
  ...
  801330:	39 e8                	cmp    %ebp,%eax
  801332:	77 24                	ja     801358 <__udivdi3+0x78>
  801334:	0f bd e8             	bsr    %eax,%ebp
  801337:	83 f5 1f             	xor    $0x1f,%ebp
  80133a:	75 3c                	jne    801378 <__udivdi3+0x98>
  80133c:	8b 74 24 04          	mov    0x4(%esp),%esi
  801340:	39 34 24             	cmp    %esi,(%esp)
  801343:	0f 86 9f 00 00 00    	jbe    8013e8 <__udivdi3+0x108>
  801349:	39 d0                	cmp    %edx,%eax
  80134b:	0f 82 97 00 00 00    	jb     8013e8 <__udivdi3+0x108>
  801351:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  801358:	31 d2                	xor    %edx,%edx
  80135a:	31 c0                	xor    %eax,%eax
  ...
  80136a:	f7 f1                	div    %ecx
  80136c:	31 d2                	xor    %edx,%edx
  ...
  80137a:	8b 3c 24             	mov    (%esp),%edi
  80137d:	d3 e0                	shl    %cl,%eax
  80137f:	89 c6                	mov    %eax,%esi
  801381:	b8 20 00 00 00       	mov    $0x20,%eax
  801386:	29 e8                	sub    %ebp,%eax
  801388:	89 c1                	mov    %eax,%ecx
  80138a:	d3 ef                	shr    %cl,%edi
  80138c:	89 e9                	mov    %ebp,%ecx
  80138e:	89 7c 24 08          	mov    %edi,0x8(%esp)
  801392:	8b 3c 24             	mov    (%esp),%edi
  801395:	09 74 24 08          	or     %esi,0x8(%esp)
  ...
  8013a6:	d3 ee                	shr    %cl,%esi
  8013a8:	89 e9                	mov    %ebp,%ecx
  8013aa:	d3 e2                	shl    %cl,%edx
  8013ac:	89 c1                	mov    %eax,%ecx
  8013ae:	d3 ef                	shr    %cl,%edi
  8013b0:	09 d7                	or     %edx,%edi
  8013b2:	89 f2                	mov    %esi,%edx
  8013b4:	89 f8                	mov    %edi,%eax
  8013b6:	f7 74 24 08          	divl   0x8(%esp)
  8013ba:	89 d6                	mov    %edx,%esi
  8013bc:	89 c7                	mov    %eax,%edi
  8013be:	f7 24 24             	mull   (%esp)
  8013c1:	39 d6                	cmp    %edx,%esi
  8013c3:	89 14 24             	mov    %edx,(%esp)
  8013c6:	72 30                	jb     8013f8 <__udivdi3+0x118>
  8013c8:	8b 54 24 04          	mov    0x4(%esp),%edx
  8013cc:	89 e9                	mov    %ebp,%ecx
  8013ce:	d3 e2                	shl    %cl,%edx
  8013d0:	39 c2                	cmp    %eax,%edx
  8013d2:	73 05                	jae    8013d9 <__udivdi3+0xf9>
  8013d4:	3b 34 24             	cmp    (%esp),%esi
  8013d7:	74 1f                	je     8013f8 <__udivdi3+0x118>
  8013d9:	89 f8                	mov    %edi,%eax
  8013db:	31 d2                	xor    %edx,%edx
  8013dd:	e9 7a ff ff ff       	jmp    80135c <__udivdi3+0x7c>
  8013e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  8013e8:	31 d2                	xor    %edx,%edx
  8013ea:	b8 01 00 00 00       	mov    $0x1,%eax
  8013ef:	e9 68 ff ff ff       	jmp    80135c <__udivdi3+0x7c>
  8013f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  8013f8:	8d 47 ff             	lea    -0x1(%edi),%eax
...
00801410 <__umoddi3>:
  ...
  80141a:	8b 4c 24 24          	mov    0x24(%esp),%ecx
  80141e:	8b 74 24 2c          	mov    0x2c(%esp),%esi
  801422:	89 c7                	mov    %eax,%edi
  801424:	89 44 24 04          	mov    %eax,0x4(%esp)
  801428:	8b 44 24 30          	mov    0x30(%esp),%eax
  80142c:	89 4c 24 10          	mov    %ecx,0x10(%esp)
  801430:	89 34 24             	mov    %esi,(%esp)
  801433:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  801437:	85 c0                	test   %eax,%eax
  801439:	89 c2                	mov    %eax,%edx
  80143b:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  80143f:	75 17                	jne    801458 <__umoddi3+0x48>
  801441:	39 fe                	cmp    %edi,%esi
  801443:	76 4b                	jbe    801490 <__umoddi3+0x80>
  801445:	89 c8                	mov    %ecx,%eax
  801447:	89 fa                	mov    %edi,%edx
  801449:	f7 f6                	div    %esi
  80144b:	89 d0                	mov    %edx,%eax
  80144d:	31 d2                	xor    %edx,%edx
  80144f:	83 c4 14             	add    $0x14,%esp
  801452:	5e                   	pop    %esi
  801453:	5f                   	pop    %edi
  801454:	5d                   	pop    %ebp
  801455:	c3                   	ret    
  ...
  80145a:	77 54                	ja     8014b0 <__umoddi3+0xa0>
  80145c:	0f bd e8             	bsr    %eax,%ebp
  80145f:	83 f5 1f             	xor    $0x1f,%ebp
  801462:	75 5c                	jne    8014c0 <__umoddi3+0xb0>
  801464:	8b 7c 24 08          	mov    0x8(%esp),%edi
  801468:	39 3c 24             	cmp    %edi,(%esp)
  80146b:	0f 87 e7 00 00 00    	ja     801558 <__umoddi3+0x148>
  801471:	8b 7c 24 04          	mov    0x4(%esp),%edi
  801475:	29 f1                	sub    %esi,%ecx
  801477:	19 c7                	sbb    %eax,%edi
  801479:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  80147d:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  801481:	8b 44 24 08          	mov    0x8(%esp),%eax
  801485:	8b 54 24 0c          	mov    0xc(%esp),%edx
  801489:	83 c4 14             	add    $0x14,%esp
  80148c:	5e                   	pop    %esi
  80148d:	5f                   	pop    %edi
  80148e:	5d                   	pop    %ebp
  80148f:	c3                   	ret    
  801490:	85 f6                	test   %esi,%esi
  801492:	89 f5                	mov    %esi,%ebp
  801494:	75 0b                	jne    8014a1 <__umoddi3+0x91>
  801496:	b8 01 00 00 00       	mov    $0x1,%eax
  80149b:	31 d2                	xor    %edx,%edx
  80149d:	f7 f6                	div    %esi
  80149f:	89 c5                	mov    %eax,%ebp
  8014a1:	8b 44 24 04          	mov    0x4(%esp),%eax
  8014a5:	31 d2                	xor    %edx,%edx
  8014a7:	f7 f5                	div    %ebp
  8014a9:	89 c8                	mov    %ecx,%eax
  8014ab:	f7 f5                	div    %ebp
  8014ad:	eb 9c                	jmp    80144b <__umoddi3+0x3b>
  8014af:	90                   	nop
  ...
  8014c0:	8b 04 24             	mov    (%esp),%eax
  8014c3:	be 20 00 00 00       	mov    $0x20,%esi
  8014c8:	89 e9                	mov    %ebp,%ecx
  8014ca:	29 ee                	sub    %ebp,%esi
  8014cc:	d3 e2                	shl    %cl,%edx
  8014ce:	89 f1                	mov    %esi,%ecx
  8014d0:	d3 e8                	shr    %cl,%eax
  8014d2:	89 e9                	mov    %ebp,%ecx
  8014d4:	89 44 24 04          	mov    %eax,0x4(%esp)
  8014d8:	8b 04 24             	mov    (%esp),%eax
  8014db:	09 54 24 04          	or     %edx,0x4(%esp)
  8014df:	89 fa                	mov    %edi,%edx
  8014e1:	d3 e0                	shl    %cl,%eax
  8014e3:	89 f1                	mov    %esi,%ecx
  8014e5:	89 44 24 08          	mov    %eax,0x8(%esp)
  8014e9:	8b 44 24 10          	mov    0x10(%esp),%eax
  8014ed:	d3 ea                	shr    %cl,%edx
  8014ef:	89 e9                	mov    %ebp,%ecx
  8014f1:	d3 e7                	shl    %cl,%edi
  8014f3:	89 f1                	mov    %esi,%ecx
  8014f5:	d3 e8                	shr    %cl,%eax
  8014f7:	89 e9                	mov    %ebp,%ecx
  8014f9:	09 f8                	or     %edi,%eax
  8014fb:	8b 7c 24 10          	mov    0x10(%esp),%edi
  8014ff:	f7 74 24 04          	divl   0x4(%esp)
  801503:	d3 e7                	shl    %cl,%edi
  801505:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  801509:	89 d7                	mov    %edx,%edi
  80150b:	f7 64 24 08          	mull   0x8(%esp)
  80150f:	39 d7                	cmp    %edx,%edi
  801511:	89 c1                	mov    %eax,%ecx
  801513:	89 14 24             	mov    %edx,(%esp)
  801516:	72 2c                	jb     801544 <__umoddi3+0x134>
  801518:	39 44 24 0c          	cmp    %eax,0xc(%esp)
  80151c:	72 22                	jb     801540 <__umoddi3+0x130>
  80151e:	8b 44 24 0c          	mov    0xc(%esp),%eax
  801522:	29 c8                	sub    %ecx,%eax
  801524:	19 d7                	sbb    %edx,%edi
  801526:	89 e9                	mov    %ebp,%ecx
  801528:	89 fa                	mov    %edi,%edx
  80152a:	d3 e8                	shr    %cl,%eax
  80152c:	89 f1                	mov    %esi,%ecx
  80152e:	d3 e2                	shl    %cl,%edx
  801530:	89 e9                	mov    %ebp,%ecx
  801532:	d3 ef                	shr    %cl,%edi
  801534:	09 d0                	or     %edx,%eax
  ...
  80153e:	c3                   	ret    
  80153f:	90                   	nop
  801540:	39 d7                	cmp    %edx,%edi
  801542:	75 da                	jne    80151e <__umoddi3+0x10e>
  801544:	8b 14 24             	mov    (%esp),%edx
  801547:	89 c1                	mov    %eax,%ecx
  801549:	2b 4c 24 08          	sub    0x8(%esp),%ecx
  80154d:	1b 54 24 04          	sbb    0x4(%esp),%edx
  801551:	eb cb                	jmp    80151e <__umoddi3+0x10e>
  801553:	90                   	nop
  801554:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  801558:	3b 44 24 0c          	cmp    0xc(%esp),%eax
  80155c:	0f 82 0f ff ff ff    	jb     801471 <__umoddi3+0x61>
  801562:	e9 1a ff ff ff       	jmp    801481 <__umoddi3+0x71>
