...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800168:	c7 04 24 58 12 80 00 	movl   $0x801258,(%esp)
  ...
  80017e:	e8 51 00 00 00       	call   8001d4 <vcprintf>
	cprintf("\n");
  800183:	c7 04 24 e8 11 80 00 	movl   $0x8011e8,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002bf:	e8 7c 0c 00 00       	call   800f40 <__udivdi3>
  ...
  80031f:	e8 4c 0d 00 00       	call   801070 <__umoddi3>
  800324:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800328:	0f be 80 7b 12 80 00 	movsbl 0x80127b(%eax),%eax
...
008003be <vprintfmt>:
{
  ...
  800443:	ff 24 8d 40 13 80 00 	jmp    *0x801340(,%ecx,4)
  ...
  80050f:	c7 44 24 08 9c 12 80 	movl   $0x80129c,0x8(%esp)
  800516:	00 
  ...
  800541:	b8 8c 12 80 00       	mov    $0x80128c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c10:	00 
  800c11:	c7 44 24 08 c4 14 80 	movl   $0x8014c4,0x8(%esp)
  800c18:	00 
  800c19:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c20:	00 
  800c21:	c7 04 24 e1 14 80 00 	movl   $0x8014e1,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800ca2:	00 
  800ca3:	c7 44 24 08 c4 14 80 	movl   $0x8014c4,0x8(%esp)
  800caa:	00 
  800cab:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cb2:	00 
  800cb3:	c7 04 24 e1 14 80 00 	movl   $0x8014e1,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800cf5:	00 
  800cf6:	c7 44 24 08 c4 14 80 	movl   $0x8014c4,0x8(%esp)
  800cfd:	00 
  800cfe:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d05:	00 
  800d06:	c7 04 24 e1 14 80 00 	movl   $0x8014e1,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800d48:	00 
  800d49:	c7 44 24 08 c4 14 80 	movl   $0x8014c4,0x8(%esp)
  800d50:	00 
  800d51:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d58:	00 
  800d59:	c7 04 24 e1 14 80 00 	movl   $0x8014e1,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800d9b:	00 
  800d9c:	c7 44 24 08 c4 14 80 	movl   $0x8014c4,0x8(%esp)
  800da3:	00 
  800da4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dab:	00 
  800dac:	c7 04 24 e1 14 80 00 	movl   $0x8014e1,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800dee:	00 
  800def:	c7 44 24 08 c4 14 80 	movl   $0x8014c4,0x8(%esp)
  800df6:	00 
  800df7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800dfe:	00 
  800dff:	c7 04 24 e1 14 80 00 	movl   $0x8014e1,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800e63:	00 
  800e64:	c7 44 24 08 c4 14 80 	movl   $0x8014c4,0x8(%esp)
  800e6b:	00 
  800e6c:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800e73:	00 
  800e74:	c7 04 24 e1 14 80 00 	movl   $0x8014e1,(%esp)
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800e96:	75 6f                	jne    800f07 <set_pgfault_handler+0x7f>
		// First time through!
  ...
  800eb9:	79 1c                	jns    800ed7 <set_pgfault_handler+0x4f>
			panic("set_pgfault_handler: sys_page_alloc() failed\n");
  800ebb:	c7 44 24 08 f0 14 80 	movl   $0x8014f0,0x8(%esp)
  800ec2:	00 
  800ec3:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800eca:	00 
  800ecb:	c7 04 24 54 15 80 00 	movl   $0x801554,(%esp)
  800ed2:	e8 65 f2 ff ff       	call   80013c <_panic>
		
		if ( (r = sys_env_set_pgfault_upcall(envid, _pgfault_upcall)) < 0 )
  800ed7:	c7 44 24 04 15 0f 80 	movl   $0x800f15,0x4(%esp)
  800ede:	00 
  800edf:	89 1c 24             	mov    %ebx,(%esp)
  800ee2:	e8 d9 fe ff ff       	call   800dc0 <sys_env_set_pgfault_upcall>
  800ee7:	85 c0                	test   %eax,%eax
  800ee9:	79 1c                	jns    800f07 <set_pgfault_handler+0x7f>
			panic("set_pgfault_handler: sys_env_set_pgfault_upcall\n");
  800eeb:	c7 44 24 08 20 15 80 	movl   $0x801520,0x8(%esp)
  800ef2:	00 
  800ef3:	c7 44 24 04 26 00 00 	movl   $0x26,0x4(%esp)
  800efa:	00 
  800efb:	c7 04 24 54 15 80 00 	movl   $0x801554,(%esp)
  800f02:	e8 35 f2 ff ff       	call   80013c <_panic>
...
_pgfault_upcall:
  ...
  800f16:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800f20:	83 c4 08             	add    $0x8,%esp
	mov 32(%esp), %ebx
  800f23:	8b 5c 24 20          	mov    0x20(%esp),%ebx
	mov 40(%esp), %eax
  800f27:	8b 44 24 28          	mov    0x28(%esp),%eax
	sub $4, %eax
  800f2b:	83 e8 04             	sub    $0x4,%eax
	mov %ebx, (%eax)
  800f2e:	89 18                	mov    %ebx,(%eax)
  ...
  800f35:	5c                   	pop    %esp
	...
	// LAB 4: Your code here.
	lea -4(%esp), %esp
  800f36:	8d 64 24 fc          	lea    -0x4(%esp),%esp
	ret
  800f3a:	c3                   	ret    
