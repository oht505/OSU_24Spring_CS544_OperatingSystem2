...
00007d0a <bootmain>:
{
    ...
    7d2a:	45 4c 46 
    7d2d:	75 51                	jne    7d80 <bootmain+0x76>
    ...
    7d48:	73 30                	jae    7d7a <bootmain+0x70>
		readseg(ph->p_pa, ph->p_memsz, ph->p_offset);
    7d4a:	ff 73 04             	pushl  0x4(%ebx)
    7d4d:	ff 73 14             	pushl  0x14(%ebx)
    7d50:	ff 73 0c             	pushl  0xc(%ebx)
    7d53:	e8 79 ff ff ff       	call   7cd1 <readseg>
		for (i = 0; i < ph->p_memsz - ph->p_filesz; i++) {
    7d58:	83 c4 0c             	add    $0xc,%esp
    7d5b:	31 c0                	xor    %eax,%eax
    7d5d:	8b 4b 10             	mov    0x10(%ebx),%ecx
    7d60:	8b 53 14             	mov    0x14(%ebx),%edx
    7d63:	29 ca                	sub    %ecx,%edx
    7d65:	39 d0                	cmp    %edx,%eax
    7d67:	73 0c                	jae    7d75 <bootmain+0x6b>
			*((char *) ph->p_pa + ph->p_filesz + i) = 0;
    7d69:	8d 14 08             	lea    (%eax,%ecx,1),%edx
		for (i = 0; i < ph->p_memsz - ph->p_filesz; i++) {
    7d6c:	40                   	inc    %eax
			*((char *) ph->p_pa + ph->p_filesz + i) = 0;
    7d6d:	03 53 0c             	add    0xc(%ebx),%edx
    7d70:	c6 02 00             	movb   $0x0,(%edx)
    7d73:	eb e8                	jmp    7d5d <bootmain+0x53>
	for (; ph < eph; ph++) {
    7d75:	83 c3 20             	add    $0x20,%ebx
    7d78:	eb cc                	jmp    7d46 <bootmain+0x3c>
	((void (*)(void)) (ELFHDR->e_entry))();
    7d7a:	ff 15 18 00 01 00    	call   *0x10018
}
...
outw(int port, uint16_t data)
{
    ...
    7d80:	ba 00 8a 00 00       	mov    $0x8a00,%edx
    7d85:	b8 00 8a ff ff       	mov    $0xffff8a00,%eax
    7d8a:	66 ef                	out    %ax,(%dx)
    7d8c:	b8 00 8e ff ff       	mov    $0xffff8e00,%eax
    7d91:	66 ef                	out    %ax,(%dx)
    7d93:	eb fe                	jmp    7d93 <bootmain+0x89>
